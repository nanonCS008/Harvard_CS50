...
function GenerateFlagPole(atlas) --spec3
    local spritesheet = {}
    spritesheet[1] = love.graphics.newQuad(4, 0, 8, 48, atlas:getDimensions()) --for flag pole
    spritesheet[2] = love.graphics.newQuad(96, 0, 16, 10, atlas:getDimensions()) --actual flag
    return spritesheet
end
