...
gTextures = {
    ...
    ['key-lock'] = love.graphics.newImage('graphics/keys_and_locks.png'), --spec2
    ['flag-pole'] = love.graphics.newImage('graphics/flags.png') --spec3
}
...
gFrames = {
    ...
    ['key-lock'] = GenerateQuads(gTextures['key-lock'], 16, 16), --spec2
    ['flag-pole'] = GenerateFlagPole(gTextures['flag-pole']) --spec3
}
